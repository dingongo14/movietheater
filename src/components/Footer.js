    ...
    <footer className="footer">
      <div className="footer__container">
        ...
        <div className="footer__brand">
          ...
          <p className="footer__tagline">Filmes e séries em um só lugar</p>
        </div>

        {/* Nav links */}
        <nav className="footer__links">
          <a href="/">Início</a>
          <a href="/search?q=ação">Ação</a>
          <a href="/search?q=drama">Drama</a>
        ...
        <div className="footer__social">
          ...
          <a
            href="https://facebook.com/alberto.david.716"
            target="_blank"
            rel="noreferrer"
            className="footer__social-link"
          >
          ...
          <a
            href="https://www.instagram.com/alberto.david.716"
            target="_blank"
            rel="noreferrer"
            className="footer__social-link"
          >
      ...
      <div className="footer__bottom">
        <p className="footer__copy">
          © {new Date().getFullYear()} CineNgongo. Dados por{" "}
        ...
        <p className="footer__powered">
          Powered by{" "}
          <a
            href="https://albertodavid.42web.io/?i=1"
            target="_blank"
            rel="noreferrer"
          >
            Alberto David
